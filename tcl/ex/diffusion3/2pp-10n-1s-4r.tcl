#
# A 2 phase pull example
# This example tests directed diffusion in a 10 node scenario with 1 sender 
# and 4 recvrs
#
# ==================================================================
# Define options
...
set opt(prestop)        199       ;# time to prepare to stop
set opt(tr)		"2pp-10n-1s-4r.tr"	;# trace file
set opt(nam)            "2pp-10n-1s-4r.nam"  ;# nam file
