...
set opt(tr)		"gear-push-5n-1s-1r.tr"	;# trace file
set opt(nam)            "gear-push-5n-1s-1r.nam"  ;# nam file
...
# starting gear filter separately
for {set i 0} {$i < $opt(nn)} {incr i} {
...
$snk_(0) push-pull-options push point 177.438 145.843
