...
set val(lla)             LL/Sat/HDLC                    ;# link layer type
set val(llb)              LL/Sat
...
LL/Sat/HDLC set max_timeouts_ 1
...
proc setup {tcptype queuetype sources qlen duration file seed c_sources delay rate ecn} {
	...
	$n(101) interface-errormodel [$val(err)]  ;#downlink
