...
set opt(cycle_protocols) true
set protocols [list TCP/Rational TCP/Linux/cubic ]; # don't put Linux TCPs first on list
set protosinks [list TCPSink TCPSink/Sack1 ]
